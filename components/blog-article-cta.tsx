...
export function BlogArticleCta({
  ...
  return (
    <section className="blog-article-cta-breakout my-14 md:my-20">
      <div className="rounded-[20px] bg-[#0E1726] px-6 py-14 text-center sm:px-10 md:py-16">
        {eyebrow ? (
        ...
        {ctaLabel && ctaUrl ? (
          <Link
            href={ctaUrl}
            className="blog-article-cta-button mt-8 inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-base font-semibold uppercase tracking-[0.06em] shadow-[0_4px_14px_rgba(0,0,0,0.25)] transition-colors hover:bg-[#F9FAFB]"
          >
            {ctaLabel}
